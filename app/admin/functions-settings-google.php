...
function astoundify_simple_social_login_panel_google() {
	$options  = get_option( 'astoundify_simple_social_login_google', [] );
...
<table class="form-table">
	<tbody>
		<tr>
			...
			<td>
				<input id="google-cb-url" type="url" class="large-text" readonly="readonly" value="<?php echo esc_url( $provider->get_endpoint_url() ); ?>">
